  ...
  return (
    <div className="relative w-full">
      <div className="flex h-screen w-full flex-col items-center justify-center space-y-12 bg-[url('/outsite-co-R-LK3sqLiBw-unsplash.jpg')] bg-cover px-4 lg:flex-row lg:space-x-40 lg:space-y-0 lg:pt-16">
        ...
        <div className="z-40 flex h-72 w-64 flex-col items-center justify-center space-y-6 rounded-2xl bg-black bg-opacity-25 px-2 text-gray-100">
          ...
          <div className="flex space-x-8">
            <div className="flex flex-col items-center">
              ...
              <h2 className="text-sm">Areasqft</h2>
            </div>
            <div className="flex flex-col items-center">
            ...
            <div className="flex flex-col items-center">
              ...
              <h2 className="text-sm">Toilet</h2>
            </div>
          </div>
          <div className="flex">
            <h2 className="bg-[#D4AF37] px-2 py-1 text-xs font-medium text-gray-900">
              From AED 20000
            </h2>
            <Link
              href={{
